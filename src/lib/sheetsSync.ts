...
export const DEFAULT_SYNC_DATA: Record<string, { val: string; category: string; desc: string }> = {
  ...
  chapter2_period: { val: "Sights & Celebrations", category: "Storyline", desc: "Story Chapter 2 Period/Meta info" },
  chapter2_date: { val: "April & May 2026", category: "Storyline", desc: "Story Chapter 2 Date" },
  chapter2_badge: { val: "Shared Moments", category: "Storyline", desc: "Story Chapter 2 Badge text" },
  ...
  chapter3_badge: { val: "Shared Milestones", category: "Storyline", desc: "Story Chapter 3 Badge text" },
